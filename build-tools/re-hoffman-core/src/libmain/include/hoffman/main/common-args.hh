...
struct MixPrintJSON : virtual Args
{
     ...
     * about extensibility, https://hoffman.dev/manual/hoffman/development/development/json-guideline.html -
...
struct MixRepair : virtual Args
{
    ...
    MixRepair()
    {
        addFlag({
            .longName = "repair",
            .description = "During evaluation, rewrite missing or corrupted files in the Hoffman store. "
