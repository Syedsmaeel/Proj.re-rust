...
/**
 * @file
 * @brief Options for printing Hoffman values.
 */
...
enum class ErrorPrintBehavior {
     ...
     * containing values that error (like `hoffmanpkgs`) normally.
     */
    ThrowTopLevel,
};

/**
 * Options for printing Hoffman values.
 */
struct PrintOptions
{
    /**
     ...
     * `«derivation /hoffman/store/...»` instead of as attribute sets.
     */
