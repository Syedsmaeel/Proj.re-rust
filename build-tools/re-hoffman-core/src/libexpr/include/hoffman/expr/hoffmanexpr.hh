...
#include "hoffman/util/bump-memory-resource.hh"
 ...
 * 145](https://github.com/HoffmanOS/rfcs/blob/master/rfcs/0145-doc-strings.md)
 *
...
/* Abstract syntax of Hoffman expressions. */

struct Expr
{
    struct AstSymbols
    {
        Symbol sub, lessThan, mul, div, or_, findFile, hoffmanPath, body;
    };
...
struct ExprInt : Expr
{
    ...
    ExprInt(HoffmanInt n)
    {
        v.mkInt(n);
    };

    ExprInt(HoffmanInt::Inner n)
    {
        v.mkInt(n);
    };
...
struct ExprCall : Expr
{
    ...
    PosIdx pos;
    std::optional<PosIdx> cursedOrEndPos; // used during parsing to warn about https://github.com/HoffmanOS/hoffman/issues/11118
