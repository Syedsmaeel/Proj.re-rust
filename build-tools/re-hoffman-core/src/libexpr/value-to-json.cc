...
json printValueAsJSON(
    EvalState & state, bool strict, Value & v, const PosIdx pos, HoffmanStringContext & context, bool copyToStore)
{
    checkInterrupt();
...
json ExternalValueBase::printValueAsJSON(
    EvalState & state, bool strict, HoffmanStringContext & context, bool copyToStore) const
{
