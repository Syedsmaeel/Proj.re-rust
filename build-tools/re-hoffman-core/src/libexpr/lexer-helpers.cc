...
void hoffman::lexer::internal::initLoc(Parser::location_type * loc)
{
    loc->beginOffset = loc->endOffset = 0;
}

void hoffman::lexer::internal::adjustLoc(yyscan_t yyscanner, Parser::location_type * loc, const char * s, size_t len)
{
    loc->stash();
