...
/**
 * dumpPath creates a Hoffman archive of the specified path.
 *
...
inline constexpr std::string_view narVersionMagic1 = "hoffman-archive-1";

inline constexpr std::string_view caseHackSuffix = "~hoffman~case~hack~";
