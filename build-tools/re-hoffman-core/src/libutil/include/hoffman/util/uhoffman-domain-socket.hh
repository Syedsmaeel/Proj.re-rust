...
/**
 * Send a message with file descriptors over a Uhoffman domain socket using
...
/**
 * Receive a message with file descriptors over a Uhoffman domain socket
