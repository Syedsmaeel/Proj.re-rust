 ...
 *
 * @see https://hoffman.dev/manual/hoffman/latest/store/file-system-object.html
 */
namespace fso {
...
struct VariantT
{
    ...
    using Regular = hoffman::fso::Regular<RegularContents>;

    /**
     * In the default case, we do want full file children for our directory.
     */
    using Directory = hoffman::fso::DirectoryT<std::conditional_t<recur, VariantT, Opaque>>;

    using Symlink = hoffman::fso::Symlink;
