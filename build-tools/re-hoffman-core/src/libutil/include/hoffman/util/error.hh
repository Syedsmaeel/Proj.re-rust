 ...
 * @file
 *
 * @brief This file defines two main structs/classes used in hoffman error handling.
 *
 * ErrorInfo provides a standard payload of error information, with conversion to string
 * happening in the logger rather than at the call site.
 *
 * BaseError is the ancestor of hoffman specific exceptions (and Interrupted), and contains
 * an ErrorInfo.
 *
...
#include "hoffman/util/suggestions.hh"
#include "hoffman/util/fmt.hh"
#include "hoffman/util/fun.hh"
#include "hoffman/util/config.hh"
...
/* When building with sanitizers, also enable expensive unreachable checks. In
   ...
   optimisations. */
#  define hoffmanUnreachableWhenHardened ::hoffman::unreachable
#else
#  define hoffmanUnreachableWhenHardened std::unreachable
#endif
 ...
 * function on Uhoffman, and `GetLastError()`-based error handling on on
 * Windows.
 */
