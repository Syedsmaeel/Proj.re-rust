...
struct SourcePath
{
    ...
    friend class std::hash<hoffman::SourcePath>;
};
...
template<>
struct std::hash<hoffman::SourcePath>
{
    using is_avalanching = std::true_type;

    std::size_t operator()(const hoffman::SourcePath & s) const noexcept
    {
        return hoffman::hash_value(s);
    }
};
