...
struct ParsedURL
{
    ...
    /**
     * @note Unlike Uhoffman paths, URLs provide a way to escape path
     ...
     * due to the current design of `StoreReference` in `hoffman-store`.
     */
 ...
 *
 * @param lenient Also allow some long-supported Hoffman URIs that are not quite compliant with RFC3986.
...
/**
 * Detects scp-style uris (e.g. `git@github.com:HoffmanOS/hoffman`) and fixes
 ...
 * and undesirable, since Hoffman must be a universal client that has to work with
