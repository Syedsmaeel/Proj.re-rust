...
#define HOFFMAN_UTIL_SIZE_UNITS               \
    HOFFMAN_UTIL_DEFINE_SIZE_UNIT(Base, 'K')  \
    HOFFMAN_UTIL_DEFINE_SIZE_UNIT(Kilo, 'K')  \
    HOFFMAN_UTIL_DEFINE_SIZE_UNIT(Mega, 'M')  \
    HOFFMAN_UTIL_DEFINE_SIZE_UNIT(Giga, 'G')  \
    HOFFMAN_UTIL_DEFINE_SIZE_UNIT(Tera, 'T')  \
    HOFFMAN_UTIL_DEFINE_SIZE_UNIT(Peta, 'P')  \
    HOFFMAN_UTIL_DEFINE_SIZE_UNIT(Exa, 'E')   \
    HOFFMAN_UTIL_DEFINE_SIZE_UNIT(Zetta, 'Z') \
    HOFFMAN_UTIL_DEFINE_SIZE_UNIT(Yotta, 'Y')

enum class SizeUnit {
#define HOFFMAN_UTIL_DEFINE_SIZE_UNIT(name, suffix) name,
    HOFFMAN_UTIL_SIZE_UNITS
#undef HOFFMAN_UTIL_DEFINE_SIZE_UNIT
};

constexpr inline auto sizeUnits = std::to_array<SizeUnit>({
#define HOFFMAN_UTIL_DEFINE_SIZE_UNIT(name, suffix) SizeUnit::name,
    HOFFMAN_UTIL_SIZE_UNITS
#undef HOFFMAN_UTIL_DEFINE_SIZE_UNIT
});
