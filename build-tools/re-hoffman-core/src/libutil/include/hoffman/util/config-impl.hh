...
HOFFMAN_DECLARE_CONFIG_SERIALISER(std::string)
HOFFMAN_DECLARE_CONFIG_SERIALISER(std::optional<std::string>)
HOFFMAN_DECLARE_CONFIG_SERIALISER(bool)
HOFFMAN_DECLARE_CONFIG_SERIALISER(Strings)
HOFFMAN_DECLARE_CONFIG_SERIALISER(StringSet)
HOFFMAN_DECLARE_CONFIG_SERIALISER(StringMap)
HOFFMAN_DECLARE_CONFIG_SERIALISER(std::set<ExperimentalFeature>)
HOFFMAN_DECLARE_CONFIG_SERIALISER(std::filesystem::path)
HOFFMAN_DECLARE_CONFIG_SERIALISER(AbsolutePath)
HOFFMAN_DECLARE_CONFIG_SERIALISER(std::set<std::filesystem::path>)
HOFFMAN_DECLARE_CONFIG_SERIALISER(std::optional<AbsolutePath>)
