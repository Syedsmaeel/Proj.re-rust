...
time_t windows::fileTimeToUhoffmanTime(const FILETIME & ft)
{
    ULARGE_INTEGER ull;
    ...
    DWORD nNumberOfLinks)
{
    ...
    /* Timestamps */
    st.st_atime = fileTimeToUhoffmanTime(ftLastAccessTime);
    st.st_mtime = fileTimeToUhoffmanTime(ftLastWriteTime);
    st.st_ctime = fileTimeToUhoffmanTime(ftCreationTime);
