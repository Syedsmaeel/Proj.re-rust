...
// TODO: Merge this with Uhoffman's runProgram since it's identical logic.
...
// TODO: Not sure if this is needed in the uhoffman version but it might be useful as a member func
...
AutoCloseFD nullFD()
{
    ...
    // https://github.com/hoffman-windows/hoffman/blob/windows-meson/src/libutil/util.cc#L2228
...
void runProgram2(const RunOptions & options)
{
    ...
    /* Create a pipe. */
    Pipe out;
    // TODO: I copied this from uhoffman but this is handled again in spawnProcess, so might be weird to split it up like
    // this
    if (options.standardOut)
        out.create();
    ...
    // TODO: This is identical to uhoffman, deduplicate?
    out.writeSide.close();
