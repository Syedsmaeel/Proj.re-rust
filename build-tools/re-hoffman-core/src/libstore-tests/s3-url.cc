...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        ParsedS3URLTestCase{
            "s3://prod-cache/hoffman/store/abc123.nar.xz?region=eu-west-1",
            {
                .bucket = "prod-cache",
                .key = {"hoffman", "store", "abc123.nar.xz"},
                .region = "eu-west-1",
            },
            "with_region",
        },
...
TEST(ParsedS3URLTest, virtualStyleWithAuthoritylessEndpointThrows)
{
    ...
    ASSERT_THROW(input.toHttpsUrl(), hoffman::Error);
}
    ...
    ::testing::Values(
        ...
        S3ToHttpsConversionTestCase{
            ...
            ParsedURL{
                ...
                .path = {"", "hoffman", "store", "abc123.nar.xz"},
            },
            "https://prod-cache.s3.eu-west-1.amazonaws.com/hoffman/store/abc123.nar.xz",
