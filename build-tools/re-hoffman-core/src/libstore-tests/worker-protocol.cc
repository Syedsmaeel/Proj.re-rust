...
#include "hoffman/store/tests/protocol.hh"
#include "hoffman/util/tests/characterization.hh"
...
VERSIONED_CHARACTERIZATION_TEST_NO_JSON(
    ...
    (std::tuple<WorkerProto::ClientHandshakeInfo, WorkerProto::ClientHandshakeInfo>{
        {
            .daemonHoffmanVersion = std::optional{"foo"},
        },
        {
            .daemonHoffmanVersion = std::optional{"bar"},
        },
    }))
