...
#ifndef _WIN32
URI_TEST_READ(local_shorthand_path_uhoffman, localExample_2)
#else
...
static StoreReference uhoffmanExample{
    .variant =
        StoreReference::Specified{
            .scheme = "uhoffman",
        },
...
URI_TEST(uhoffman, uhoffmanExample)

URI_TEST_READ(uhoffman_shorthand, uhoffmanExample)
