...
#include "hoffman/store/tests/derived-path.hh"
...
{
    std::string_view opaque = "/hoffman/store/g1w7hy3qg1w7hy3qg1w7hy3qg1w7hy3q-x";
...
{
    std::string_view built = "/hoffman/store/g1w7hy3qg1w7hy3qg1w7hy3qg1w7hy3q-x.drv^bar,foo";
...
TEST_F(DerivedPathTest, built_built)
{
    ...
    std::string_view built = "/hoffman/store/g1w7hy3qg1w7hy3qg1w7hy3qg1w7hy3q-x.drv^foo^bar,baz";
...
{
    ASSERT_THROW(
        DerivedPath::parse(*store, "/hoffman/store/g1w7hy3qg1w7hy3qg1w7hy3qg1w7hy3q-x.drv^foo^bar,baz"),
