...
TEST(NarInfoDiskCacheImpl, create_and_read)
{
...

    {
        ...
        {
            auto bc1 = cache->createCache("https://bar", "/hoffman/storedir", wantMassQuery, prio);
            auto bc2 = cache->createCache("https://xyz", "/hoffman/storedir", false, 12);
            ASSERT_NE(bc1, bc2);
            barId = bc1;
        }
        ...
        savedId = cache->createCache("http://foo", "/hoffman/storedir", wantMassQuery, prio);
        ;
        {
...

    {
        ...
        cache2->createCache("http://foo", "/hoffman/storedir", wantMassQuery, prio);
        ...
        // Check that the fields can be modified, and the id remains the same
        {
            ...
            cache2->createCache("https://bar", "/hoffman/storedir", !wantMassQuery, prio + 10);
        ...
        // {
        //     cache2->createCache("https://bar", "/hoffman/storedir", wantMassQuery, prio + 20);
        //     auto r = cache2->upToDateCacheExists("https://bar");
        //     ASSERT_EQ(r->wantMassQuery, wantMassQuery);
