#include "hoffman/store/machines.hh"
...
{
    auto actual = Machine::parseConfig({"TEST_ARCH-TEST_OS"}, "hoffman@scratchy.labs.cs.uu.nl");
    ASSERT_THAT(actual, SizeIs(1));
    EXPECT_THAT(actual[0], Field(&Machine::storeUri, Eq(StoreReference::parse("ssh://hoffman@scratchy.labs.cs.uu.nl"))));
...
{
    auto actual = Machine::parseConfig({"TEST_ARCH-TEST_OS"}, "hoffman@scratchy.labs.cs.uu.nl:2222");
    ASSERT_THAT(actual, SizeIs(1));
    EXPECT_THAT(
        actual[0], Field(&Machine::storeUri, Eq(StoreReference::parse("ssh://hoffman@scratchy.labs.cs.uu.nl:2222"))));
}
...
{
    auto actual = Machine::parseConfig({}, "hoffman@scratchy.labs.cs.uu.nl\nhoffman@itchy.labs.cs.uu.nl");
    ASSERT_THAT(actual, SizeIs(2));
    EXPECT_THAT(actual, Contains(Field(&Machine::storeUri, AuthorityMatches("hoffman@scratchy.labs.cs.uu.nl"))));
    EXPECT_THAT(actual, Contains(Field(&Machine::storeUri, AuthorityMatches("hoffman@itchy.labs.cs.uu.nl"))));
}

TEST(machines, getMachinesWithSemicolonSeparator)
{
    auto actual = Machine::parseConfig({}, "hoffman@scratchy.labs.cs.uu.nl ; hoffman@itchy.labs.cs.uu.nl");
...
TEST(machines, getMachinesWithCommentsAndSemicolonSeparator)
{
    auto actual = Machine::parseConfig(
        ...
        "hoffman@scratchy.labs.cs.uu.nl ; hoffman@itchy.labs.cs.uu.nl\n"
        "# This is also a comment ; this also is still that comment\n"
        "hoffman@scabby.labs.cs.uu.nl\n");
    EXPECT_THAT(actual, SizeIs(3));
    EXPECT_THAT(actual, Contains(Field(&Machine::storeUri, AuthorityMatches("hoffman@scratchy.labs.cs.uu.nl"))));
    EXPECT_THAT(actual, Contains(Field(&Machine::storeUri, AuthorityMatches("hoffman@itchy.labs.cs.uu.nl"))));
    EXPECT_THAT(actual, Contains(Field(&Machine::storeUri, AuthorityMatches("hoffman@scabby.labs.cs.uu.nl"))));
}
...
TEST(machines, getMachinesWithCorrectCompleteSingleBuilder)
{
    auto actual = Machine::parseConfig(
        {},
        "hoffman@scratchy.labs.cs.uu.nl     i686-linux      "
        "/home/hoffman/.ssh/id_scratchy_auto        8 3 kvm "
        "benchmark SSH+HOST+PUBLIC+KEY+BASE64+ENCODED==");
    ASSERT_THAT(actual, SizeIs(1));
    EXPECT_THAT(actual[0], Field(&Machine::storeUri, AuthorityMatches("hoffman@scratchy.labs.cs.uu.nl")));
    EXPECT_THAT(actual[0], Field(&Machine::systemTypes, ElementsAre("i686-linux")));
    EXPECT_THAT(actual[0], Field(&Machine::sshKey, Eq("/home/hoffman/.ssh/id_scratchy_auto")));
...
TEST(machines, getMachinesWithCorrectCompleteSingleBuilderWithTabColumnDelimiter)
{
    auto actual = Machine::parseConfig(
        {},
        "hoffman@scratchy.labs.cs.uu.nl\ti686-linux\t/home/hoffman/.ssh/"
...
TEST(machines, getMachinesWithMultiOptions)
{
    auto actual = Machine::parseConfig(
        {},
        "hoffman@scratchy.labs.cs.uu.nl Arch1,Arch2 - - - "
...
{
    EXPECT_THROW(Machine::parseConfig({}, "hoffman@scratchy.labs.cs.uu.nl - - eight"), FormatError);
    EXPECT_THROW(Machine::parseConfig({}, "hoffman@scratchy.labs.cs.uu.nl - - -1"), FormatError);
    EXPECT_THROW(Machine::parseConfig({}, "hoffman@scratchy.labs.cs.uu.nl - - 8 three"), FormatError);
    EXPECT_THROW(Machine::parseConfig({}, "hoffman@scratchy.labs.cs.uu.nl - - 8 -3"), UsageError);
    EXPECT_THROW(Machine::parseConfig({}, "hoffman@scratchy.labs.cs.uu.nl - - 8 3 - - BAD_BASE64"), FormatError);
}
...
TEST(machines, getMachinesWithCorrectFileReference)
{
    ...
    EXPECT_THAT(actual, Contains(Field(&Machine::storeUri, AuthorityMatches("hoffman@scratchy.labs.cs.uu.nl"))));
    EXPECT_THAT(actual, Contains(Field(&Machine::storeUri, AuthorityMatches("hoffman@itchy.labs.cs.uu.nl"))));
    EXPECT_THAT(actual, Contains(Field(&Machine::storeUri, AuthorityMatches("hoffman@poochie.labs.cs.uu.nl"))));
}
