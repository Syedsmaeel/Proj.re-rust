...
namespace hoffman {
    ...
    TEST(logEI, jsonOutput) {
        ...
        auto problem_file = testTable.create("random.hoffman");
        testing::internal::CaptureStderr();
        ...
        auto str = testing::internal::GetCapturedStderr();
        ASSERT_STREQ(str.c_str(), "@hoffman {\"action\":\"msg\",\"column\":13,\"file\":\"random.hoffman\",\"level\":0,\"line\":2,\"msg\":\"\\u001b[31;1merror:\\u001b[0m\\u001b[34;1m --- error name --- error-unit-test\\u001b[0m\\n\\u001b[34;1mat: \\u001b[33;1m(2:13)\\u001b[34;1m in file: \\u001b[0mrandom.hoffman\\n\\nerror without any code lines.\\n\\nthis hint has \\u001b[33;1myellow\\u001b[0m templated \\u001b[33;1mvalues\\u001b[0m!!\",\"raw_msg\":\"this hint has \\u001b[33;1myellow\\u001b[0m templated \\u001b[33;1mvalues\\u001b[0m!!\"}\n");
    }
    ...
    TEST(addTrace, showTracesWithShowTrace) {
        ...
        e.addTrace(Pos(foFile, invalidfilename, 100, 1), "missing %s", "hoffman file");
