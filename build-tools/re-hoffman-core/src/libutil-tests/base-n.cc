...
/* Hoffman's Base64 implementation has historically accepted trailing
   garbage. We may want to warn about this in the future, but we cannot
   take it away suddenly.

   Test case taken from Shoffman:
   https://git.shoffman.dev/shoffman/shoffman/src/commit/2a29b90c7f3f3c52b5bdae50260fb0bd903c6b38/shoffman/hoffman-compat/src/hoffmanhash/mod.rs#L431
 */
