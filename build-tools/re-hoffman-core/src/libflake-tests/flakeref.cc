...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        InputFromURLTestCase{
            ...
            .expectedUrl = "flake:hoffmanpkgs/branch",
        },
        InputFromURLTestCase{
            ...
            .expectedUrl = "flake:hoffmanpkgs/branch/2aae6c35c94fcfb415dbe95f408b9ce91ee846ed",
        },
...
TEST(parseFlakeRef, malformedGithubUrlDoesNotCrash)
{
    ...
    EXPECT_THROW(
        parseFlakeRef(fetchSettings, "github:hoffmanos/hoffmanpkgs/hoffmanpkgs.git?ref=aead170c1a49253ebfa5027010dfd89a77b73ca4"),
        Error);
}
