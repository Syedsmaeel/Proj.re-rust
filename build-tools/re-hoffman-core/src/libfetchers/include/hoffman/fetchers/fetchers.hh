...
public:
    ...
    /**
     * Fetch the entire input into the Hoffman store, returning the
     * location in the Hoffman store and the locked input.
     */
...
public:
     ...
     *
     * This is not a stable identifier between Hoffman versions, but not guaranteed to change either.
     */
 ...
 * registers with hoffman at startup time.  When processing an `Input`,
