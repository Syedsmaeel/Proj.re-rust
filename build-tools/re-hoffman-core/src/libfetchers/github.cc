...
struct GitArchiveInputScheme : InputScheme
{
    ...
    virtual RefInfo getRevFromRef(const Settings & settings, hoffman::Store & store, const Input & input) const = 0;
...
struct GitHubInputScheme : GitArchiveInputScheme
{
    ...
    RefInfo getRevFromRef(const Settings & settings, hoffman::Store & store, const Input & input) const override
    {
