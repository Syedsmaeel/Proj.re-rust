...
TEST(hoffman_isAllowedURI, http_example_com)
{
    Strings allowed;
...
TEST(hoffman_isAllowedURI, http_example_com_foo)
{
    Strings allowed;
...
TEST(hoffman_isAllowedURI, http)
{
    Strings allowed;
...
TEST(hoffman_isAllowedURI, https)
{
    Strings allowed;
...
TEST(hoffman_isAllowedURI, absolute_path)
{
    Strings allowed;
...
TEST(hoffman_isAllowedURI, file_url)
{
    Strings allowed;
...
TEST(hoffman_isAllowedURI, github_all)
{
    Strings allowed;
...
TEST(hoffman_isAllowedURI, github_org)
{
    Strings allowed;
...
TEST(hoffman_isAllowedURI, non_scheme_colon)
{
    Strings allowed;
...
TEST_F(PureEvalTest, pathExists)
{
    ...
    ASSERT_THAT(eval("builtins.pathExists /hoffman"), IsFalse());
    ASSERT_THAT(eval("builtins.pathExists /hoffman/store"), IsFalse());
