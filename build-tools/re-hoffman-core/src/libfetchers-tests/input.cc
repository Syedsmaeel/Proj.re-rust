...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        InputFromAttrsTestCase{
            .attrs =
                {
                    {"url", Attr("git+ssh://git@github.com/HoffmanOS/hoffmanpkgs")},
                    {"type", Attr("git")},
                },
            .expectedUrl = "git+ssh://git@github.com/HoffmanOS/hoffmanpkgs",
            .description = "strips_git_plus_prefix",
            .expectedAttrs =
                {
                    {"url", Attr("ssh://git@github.com/HoffmanOS/hoffmanpkgs")},
                    {"type", Attr("git")},
                },
        }),
