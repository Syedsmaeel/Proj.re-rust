...
TEST(getNameFromURL, getNameFromURL)
{
    ...
    ASSERT_EQ(getNameFromURL(parseURL("path:./repos/mygrass#nonStandardAttr.mylaptop")), "mylaptop");
    ASSERT_EQ(
    ...
    ASSERT_EQ(getNameFromURL(parseURL("file+http://gitfantasy.com/org/user/notagrass")), "notagrass");
