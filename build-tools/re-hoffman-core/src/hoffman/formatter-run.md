...
`hoffman fmt` (an alias for `hoffman formatter run`) calls the formatter specified in the flake.
...
will be set to the absolute path to the directory containing the closest parent `flake.hoffman`
