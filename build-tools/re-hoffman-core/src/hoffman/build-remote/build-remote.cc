...
{
    {
        /* Upon exiting, Hoffman will attempt to terminate this process with
           SIGTERM. initHoffman will block or handle SIGTERM, so we need to unblock
        ...
        */
        ...
        if (auto localStore = store.dynamic_pointer_cast<LocalFSStore>())
            ...
            currentLoad = std::filesystem::path{settings.hoffmanStateDir} / "current-load";
