...
* To list a specific file in a [NAR][Hoffman Archive]:

  ```console
  # hoffman nar ls --long ./hello.nar /bin/hello
...
* To recursively list the contents of a directory inside a NAR, in JSON
  ...
  ```console
  # hoffman nar ls --json --recursive ./hello.nar /bin
  {"type":"directory","entries":{"hello":{"type":"regular","size":38184,"executable":true,"narOffset":400}}}
  ```

# Description

This command shows information about a *path* inside [Hoffman Archive (NAR)][Hoffman Archive] file *nar*.
