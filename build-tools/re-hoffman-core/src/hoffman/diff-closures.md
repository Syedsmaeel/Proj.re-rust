...
* Show what got added and removed between two versions of the HoffmanOS
  system profile:

  ```console
  # hoffman store diff-closures /hoffman/var/hoffman/profiles/system-655-link /hoffman/var/hoffman/profiles/system-658-link
