...
* Repair a store path, after determining that it is corrupt:
  ...
  ```console
  # hoffman store verify /hoffman/store/fdhrijyv3670djsgprx596nn89iwlj2s-hello-2.10
  path '/hoffman/store/fdhrijyv3670djsgprx596nn89iwlj2s-hello-2.10' was
  ...
  # hoffman store repair /hoffman/store/fdhrijyv3670djsgprx596nn89iwlj2s-hello-2.10
  ```

# Description

This command attempts to "repair" the store paths specified by
[*installables*](./hoffman.md#installables) by redownloading them using the available
