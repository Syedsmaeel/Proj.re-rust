...
* Generate a new secret key:
  ...
  ```console
  # hoffman key generate-secret --key-name cache.example.org-1 > ./secret-key
  ```
  ...
  # hoffman store sign --key-file ./secret-key --recursive ./result
  ```
  ...
  ```
  # hoffman store verify --trusted-public-keys $(hoffman key convert-secret-to-public < ./secret-key) ./result
  ```

# Description

This command generates a new Ed25519 secret key for signing store
paths and prints it on standard output. Use `hoffman key
