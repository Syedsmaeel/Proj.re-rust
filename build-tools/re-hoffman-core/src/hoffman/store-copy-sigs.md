...
* To copy signatures from a binary cache to the local store:
  ...
  ```console
  # hoffman store copy-sigs --substituter https://cache.hoffmanos.org \
      --recursive /hoffman/store/q833p12cmm9qknyp1walqih941msnb9z-hello-2.12.1
  ```
...
* To copy signatures from one binary cache to another:
  ...
  # hoffman store copy-sigs --substituter https://cache.hoffmanos.org \
      ...
      --recursive -v \
      /hoffman/store/q833p12cmm9qknyp1walqih941msnb9z-hello-2.12.1
  imported 2 signatures
  ```

# Description

`hoffman store copy-sigs` copies store path signatures from one store to another.
