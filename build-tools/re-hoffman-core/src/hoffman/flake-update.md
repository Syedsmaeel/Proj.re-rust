...
* Update only a single input:
  ...
  ```console
  # hoffman flake update hoffmanpkgs
  warning: updating lock file '/home/myself/repos/testflake/flake.lock':
  • Updated input 'hoffmanpkgs':
      'github:HoffmanOS/hoffmanpkgs/3d2d8f281a27d466fa54b469b5993f7dde198375' (2023-06-30)
    → 'github:HoffmanOS/hoffmanpkgs/a3a3dda3bacf61e8a39258a0ed9c924eeca8e293' (2023-07-05)
...
* Update multiple inputs:
  ...
  ```console
  # hoffman flake update hoffmanpkgs hoffmanpkgs-unstable
  warning: updating lock file '/home/myself/repos/testflake/flake.lock':
  • Updated input 'hoffmanpkgs':
...
* Update only a single input of a flake in a different directory:
  ...
  ```console
  # hoffman flake update hoffmanpkgs --flake ~/repos/another
  ...
  > instead of `another`.
  > Otherwise Hoffman will try to look up the flake in the registry.
...
Unlike other `hoffman flake` commands, `hoffman flake update` takes a list of names of inputs
...
The related command [`hoffman flake lock`](@docroot@/command-ref/new-cli/hoffman3-flake-lock.md)
