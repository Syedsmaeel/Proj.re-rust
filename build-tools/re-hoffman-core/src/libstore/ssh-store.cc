#include "hoffman/store/ssh-store.hh"
...
SSHStoreConfig::SSHStoreConfig(const ParsedURL::Authority & authority, const Params & params)
    : Store::Config{params, FilePathType::Uhoffman}
    , RemoteStore::Config{params, FilePathType::Uhoffman}
 ...
 * shared with the local host. This means that the remote hoffman store is
 ...
 * superficial difference of SSH vs Uhoffman domain sockets, they both are
