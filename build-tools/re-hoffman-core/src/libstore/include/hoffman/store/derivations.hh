...
#include "hoffman/store/derived-path-map.hh"
...
struct Derivation : BasicDerivation
{
    ...
    /**
     * Like the above, but instead of querying the Hoffman database for
 ...
 * Used by `hoffman derivation show` and `hoffman derivation add`.
 */
constexpr unsigned expectedJsonVersionDerivation = 4;

} // namespace hoffman

JSON_IMPL_WITH_XP_FEATURES(hoffman::DerivationOutput)
JSON_IMPL_WITH_XP_FEATURES(hoffman::BasicDerivation)
JSON_IMPL_WITH_XP_FEATURES(hoffman::Derivation)
