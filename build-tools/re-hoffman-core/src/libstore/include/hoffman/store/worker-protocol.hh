...
/**
 * The "worker protocol", used by uhoffman:// and ssh-ng:// stores.
 *
...
enum struct WorkerProto::Op : uint64_t {
    ...
    QueryReferrers = 6,
    AddToStore = 7,
    AddTextToStore = 8, // obsolete since 1.25, Hoffman 3.0. Use WorkerProto::Op::AddToStore
    BuildPaths = 9,
    EnsurePath = 10,
    AddTempRoot = 11,
    AddIndirectRoot = 12,
...
{
    /**
     * The version of the Hoffman daemon that is processing our requests.
     *
     * Do note, it may or may not communicating with another daemon,
     * rather than being an "end" `LocalStore` or similar.
     */
    std::optional<std::string> daemonHoffmanVersion;
