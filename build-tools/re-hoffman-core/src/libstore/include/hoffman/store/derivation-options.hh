...
struct DerivationOptions
{
    struct OutputChecks
    {
        ...
        using DrvRef = hoffman::DrvRef<Input>;
...
JSON_IMPL(hoffman::DerivationOptions<hoffman::StorePath>);
JSON_IMPL(hoffman::DerivationOptions<hoffman::SingleDerivedPath>);
JSON_IMPL(hoffman::DerivationOptions<hoffman::StorePath>::OutputChecks)
JSON_IMPL(hoffman::DerivationOptions<hoffman::SingleDerivedPath>::OutputChecks)
