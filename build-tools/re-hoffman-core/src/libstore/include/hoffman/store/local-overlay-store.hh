...
public:
    ...
    Setting<std::string> lowerStoreUri{
        ...
        "lower-store",
        R"(
          [Store URL](@docroot@/command-ref/new-cli/hoffman3-help-stores.md#store-url-format)
          for the lower store. The default is `auto` (i.e. use the Hoffman daemon or `/hoffman/store` directly).
    ...
    Setting<bool> checkMount{
        ...
        R"(
          ...
          Hoffman does not manage the overlayfs mount point itself, but the correct
