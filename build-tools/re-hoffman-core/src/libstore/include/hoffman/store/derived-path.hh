...
/**
 * A "derived path" is a very simple sort of expression (not a Hoffman
...
JSON_IMPL(hoffman::SingleDerivedPath::Opaque)
JSON_IMPL_WITH_XP_FEATURES(hoffman::SingleDerivedPath::Built)
JSON_IMPL_WITH_XP_FEATURES(hoffman::SingleDerivedPath)
JSON_IMPL_WITH_XP_FEATURES(hoffman::DerivedPath::Built)
JSON_IMPL_WITH_XP_FEATURES(hoffman::DerivedPath)
