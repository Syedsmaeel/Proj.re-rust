 ...
 * Useful for cycle detection and detailed dependency analysis like `hoffman why-depends --precise`.
 *
 ...
 * "/hoffman/store/dc04vv14dak1c1r48qa0m23vr9jy8sm0-foo" will be detected if the
