...
struct adl_serializer<hoffman::DrvRef<Item>>
{
    static hoffman::DrvRef<Item> from_json(const json & json);
    static void to_json(json & json, const hoffman::DrvRef<Item> & t);
};

extern template struct adl_serializer<hoffman::DrvRef<hoffman::StorePath>>;
extern template struct adl_serializer<hoffman::DrvRef<hoffman::SingleDerivedPath>>;
