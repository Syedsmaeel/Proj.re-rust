...
static ContentAddressMethod fileIngestionMethodToContentAddressMethod(FileIngestionMethod m)
{
    ...
    case FileIngestionMethod::HoffmanArchive:
        return ContentAddressMethod::Raw::HoffmanArchive;
    case FileIngestionMethod::Git:
...
FileIngestionMethod ContentAddressMethod::getFileIngestionMethod() const
{
    ...
    case ContentAddressMethod::Raw::HoffmanArchive:
        return FileIngestionMethod::HoffmanArchive;
    case ContentAddressMethod::Raw::Git:
...
{
    return renderPrefixModern(method) + this->hash.to_string(HashFormat::Hoffman32, true);
}
