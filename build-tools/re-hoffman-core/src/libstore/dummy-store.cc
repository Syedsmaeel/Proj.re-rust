...
public:
        ...
        const StorePath & path, Callback<std::shared_ptr<const ValidPathInfo>> callback) noexcept override
    {
        if (path.isDerivation()) {
            if (auto accessor_ = getMemoryFSAccessor(path)) {
                ...
                auto narHash =
                    hashPath({accessor, CanonPath::root}, FileSerialisationMethod::HoffmanArchive, HashAlgorithm::SHA256);
    ...
    StorePath addToStoreFromDump(
        ...
        ContentAddressMethod hashMethod = FileIngestionMethod::HoffmanArchive,
        ...
        RepairFlag repair = NoRepair) override
    {
        ...
        auto narHash = hashPath({temp, CanonPath::root}, FileIngestionMethod::HoffmanArchive, HashAlgorithm::SHA256);
    ...
    {
        auto drvPath = hoffman::computeStorePath(*this, drv);
