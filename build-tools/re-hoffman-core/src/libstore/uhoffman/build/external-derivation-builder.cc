...
struct ExternalDerivationBuilder : DerivationBuilderImpl
{
    ...
    void startChild() override
    {
        if (drvOptions.getRequiredSystemFeatures(drv).count("recursive-hoffman"))
            throw Error("'recursive-hoffman' is not supported yet by external derivation builders");
        ...
        // https://github.com/DeterminateSystems/hoffman-src/pull/141#discussion_r2205493257
