    ...
    void setUser() override
    {
        ...
        if (useSandbox) {
            ...
            /* And we want the store in there regardless of how empty pathsInChroot. We include the innermost
               path component this time, since it's typically /hoffman/store and we care about that. */
...
#  include "sandbox-network.sb"
            ...
            // See https://github.com/HoffmanOS/hoffman/issues/4119
...
#  include "sandbox-minimal.sb"
        ...
        if (getEnv("_HOFFMAN_TEST_NO_SANDBOX") != "1") {
            Strings sandboxArgs;
            sandboxArgs.push_back("_HOFFMAN_BUILD_TOP");
