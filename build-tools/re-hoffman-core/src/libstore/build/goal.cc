...
using Co = hoffman::Goal::Co;
using promise_type = hoffman::Goal::promise_type;
...
using handle_type = hoffman::Goal::handle_type;
using Suspend = hoffman::Goal::Suspend;
...
std::coroutine_handle<> hoffman::Goal::Co::await_suspend(handle_type caller)
{
