#include "hoffman/store/http-binary-cache-store.hh"
...
#include "hoffman/util/closure.hh"
...
{
    static bool forceHttp = getEnv("_HOFFMAN_FORCE_HTTP") == "1";
...
std::optional<std::string> HttpBinaryCacheStore::getHoffmanCacheInfo()
{
    try {
