...
programPath=$(hoffman-build --no-link ./gc-runtime.hoffman -A program)
environPath=$(hoffman-build --no-link ./gc-runtime.hoffman -A environ)
openPath=$(hoffman-build --no-link ./gc-runtime.hoffman -A open)
