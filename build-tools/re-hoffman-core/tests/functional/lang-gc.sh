...
# https://github.com/HoffmanOS/hoffman/issues/11141
test_issue_11141() {
  mkdir -p "$TEST_ROOT/issue-11141/src"
  cp lang-gc/issue-11141-gc-coroutine-test.hoffman "$TEST_ROOT/issue-11141/"
  (
    set +x;
    n=10
  ...
  HOFFMAN_SHOW_STATS=1 \
  hoffman eval -vvv\
    -f "$TEST_ROOT/issue-11141/issue-11141-gc-coroutine-test.hoffman"
}
test_issue_11141
