...
cp ./dependencies.hoffman ./dependencies.builder0.sh "${config_hoffman}" "$TEST_HOME"

cd "$TEST_HOME"

hoffman why-depends --derivation --file ./dependencies.hoffman input2_drv input1_drv
hoffman why-depends --file ./dependencies.hoffman input2_drv input1_drv

hoffman-build ./dependencies.hoffman -A input0_drv -o dep
hoffman-build ./dependencies.hoffman -o toplevel

FAST_WHY_DEPENDS_OUTPUT=$(hoffman why-depends ./toplevel ./dep)
PRECISE_WHY_DEPENDS_OUTPUT=$(hoffman why-depends ./toplevel ./dep --precise)
