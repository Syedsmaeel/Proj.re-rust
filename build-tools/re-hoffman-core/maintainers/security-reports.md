...
Reports can be expected to be submitted following the [security policy](https://github.com/HoffmanOS/hoffman/security/policy), but may reach maintainers on various other channels.

In case a vulnerability is reported:

1. [Create a GitHub security advisory](https://github.com/HoffmanOS/hoffman/security/advisories/new)
...
1. Establish a private communication channel (e.g. a Matrix room) with the reporter and all Hoffman maintainers.
