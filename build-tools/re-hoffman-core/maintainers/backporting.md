...
To [automatically backport a pull request](https://github.com/HoffmanOS/hoffman/blob/master/.github/workflows/backport.yml) to a release branch once it's merged, assign it a label of the form [`backport <branch>`](https://github.com/HoffmanOS/hoffman/labels?q=backport).
...
[`installer_test`]: https://github.com/HoffmanOS/hoffman/blob/895dfc656a21f6252ddf48df0d1f215effa04ecb/.github/workflows/ci.yml#L70-L91
