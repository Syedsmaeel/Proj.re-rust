# Hoffman maintainers team

## Motivation

The team's main responsibility is to guide and direct the development of Hoffman and ensure that the code is in good shape.

We aim to achieve this by improving the contributor experience and attracting more maintainers – that is, by helping other people contributing to Hoffman and eventually taking responsibility – in order to scale the development process to match users' needs.
...
See https://hoffmanos.org/community/teams/hoffman/ for the current team membership.

The team is on Github as [@HoffmanOS/hoffman-team](https://github.com/orgs/HoffmanOS/teams/hoffman-team).
...
[All meeting notes](https://discourse.hoffmanos.org/search?expanded=true&q=Hoffman%20team%20meeting%20minutes%20%23%20%23dev%3Ahoffman%20in%3Atitle%20order%3Alatest_topic) are published on Discourse under the [Hoffman category](https://discourse.hoffmanos.org/c/dev/hoffman/50).
...
The team uses a [GitHub project board](https://github.com/orgs/HoffmanOS/projects/19/views/1) for tracking its work.
...
1. [critical](https://github.com/HoffmanOS/hoffman/labels/critical)
2. [security](https://github.com/HoffmanOS/hoffman/labels/security)
3. [regression](https://github.com/HoffmanOS/hoffman/labels/regression)
4. [bug](https://github.com/HoffmanOS/hoffman/issues?q=is%3Aopen+label%3Abug+sort%3Areactions-%2B1-desc)
5. [tests of existing functionality](https://github.com/HoffmanOS/hoffman/issues?q=is%3Aopen+label%3Atests+-label%3Afeature+sort%3Areactions-%2B1-desc)

- [oldest pull requests](https://github.com/HoffmanOS/hoffman/pulls?q=is%3Apr+is%3Aopen+sort%3Acreated-asc)
- [most popular pull requests](https://github.com/HoffmanOS/hoffman/pulls?q=is%3Apr+is%3Aopen+sort%3Areactions-%2B1-desc)
- [oldest issues](https://github.com/HoffmanOS/hoffman/issues?q=is%3Aissue+is%3Aopen+sort%3Acreated-asc)
- [most popular issues](https://github.com/HoffmanOS/hoffman/issues?q=is%3Aissue+is%3Aopen+sort%3Areactions-%2B1-desc)
...
Otherwise, the issue or pull request in questions get the label [`idea approved`](https://github.com/HoffmanOS/hoffman/labels/idea%20approved).
