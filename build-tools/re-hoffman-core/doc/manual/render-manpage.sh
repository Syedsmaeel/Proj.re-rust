...
# Optional --out-no-smarty flag for compatibility with hoffman_nested_manpages
...
Arguments:
  title           - Manpage title (e.g., "hoffman-env --install")
...
Examples:
  $0 "hoffman-store --query" 1 doc/manual/source build/doc/manual/source \\
     https://hoffman.dev/manual/hoffman/latest \\
     build/doc/manual/source/command-ref/hoffman-store/query.md hoffman-store-query.1
EOF
    exit 1
}
