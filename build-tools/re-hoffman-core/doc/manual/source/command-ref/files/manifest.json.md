...
The manifest file records the provenance of the packages that are installed in a [profile](./profiles.md) managed by [`hoffman profile`](@docroot@/command-ref/new-cli/hoffman3-profile.md) (experimental).

Here is an example of what the file might look like after installing `zoom-us` from Hoffmanpkgs:
  ...
  "elements": [
    {
      ...
      "uri": "github:HoffmanOS/hoffmanpkgs/13d0c311e3ae923a00f734b43fd1d35b47d8943a"
    },
    …
  ]
}
...
* `storePath`: The paths in the Hoffman store containing the package.

* `active`: Whether the profile contains symlinks to the files of this
  package. If set to false, the package is kept in the Hoffman store, but
