...
The following options are allowed for all `hoffman-store` operations, but may not always have an effect.
...
- <span id="opt-add-root">[`--add-root`](#opt-add-root)</span> *path*
  ...
  be created in `/hoffman/var/hoffman/gcroots/auto/`. For instance,

  ```console
  $ hoffman-store --add-root /home/eelco/bla/result --realise ...

  $ ls -l /hoffman/var/hoffman/gcroots/auto
  lrwxrwxrwx    1 ... 2005-03-13 21:10 dn54lcypm8f8... -> /home/eelco/bla/result

  $ ls -l /home/eelco/bla/result
  lrwxrwxrwx    1 ... 2005-03-13 21:10 /home/eelco/bla/result -> /hoffman/store/1r11343n6qd4...-f-spot-0.0.10
  ```
