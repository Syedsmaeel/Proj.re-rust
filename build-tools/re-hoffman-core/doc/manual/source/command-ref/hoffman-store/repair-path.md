...
`hoffman --repair-path` - re-download path from substituter

# Synopsis

`hoffman-store` `--repair-path` *paths…*
...
```console
$ hoffman-store --verify-path /hoffman/store/dj7a81wsm1ijwwpkks3725661h3263p5-glibc-2.13
path `/hoffman/store/dj7a81wsm1ijwwpkks3725661h3263p5-glibc-2.13' was modified!
  expected hash `2db57715ae90b7e31ff1f2ecb8c12ec1cc43da920efcbe3b22763f36a1861588',
  got `481c5aa5483ebc97c20457bb8bca24deea56550d3985cda0027f67fe54b808e4'

$ hoffman-store --repair-path /hoffman/store/dj7a81wsm1ijwwpkks3725661h3263p5-glibc-2.13
fetching path `/hoffman/store/d7a81wsm1ijwwpkks3725661h3263p5-glibc-2.13'...
…
```
