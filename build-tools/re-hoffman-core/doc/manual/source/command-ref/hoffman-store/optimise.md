...
`hoffman-store --optimise` - reduce disk space usage
...
The operation `--optimise` reduces Hoffman store disk space usage by finding
...
considered identical when they have the same [Hoffman Archive (NAR)][Hoffman Archive] serialisation:
...
```console
$ hoffman-store --optimise
hashing files in `/hoffman/store/qhqx7l2f1kmwihc9bnxs7rc159hsxnf3-gcc-4.1.1'
...
