...
`hoffman-env --set` - set profile to contain a specified derivation

## Synopsis

`hoffman-env` `--set` *drvname*
...
```console
$ hoffman-env --profile /hoffman/var/hoffman/profiles/browser --set firefox
```
