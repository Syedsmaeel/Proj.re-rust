...
`hoffman-env --delete-generations` - delete profile generations

# Synopsis

`hoffman-env` `--delete-generations` *generations*
...
```console
$ hoffman-env --delete-generations 3 4 8
```
...
```console
$ hoffman-env --delete-generations +5
```
...
```console
$ hoffman-env --delete-generations 30d
```
...
```console
$ hoffman-env --profile other_profile --delete-generations old
```
