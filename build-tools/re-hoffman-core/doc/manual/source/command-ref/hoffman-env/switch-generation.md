...
`hoffman-env --switch-generation` - set user environment to given profile generation

# Synopsis

`hoffman-env` {`--switch-generation` | `-G`} *generation*
...
environment in the Hoffman store.
...
```console
$ hoffman-env --switch-generation 42
