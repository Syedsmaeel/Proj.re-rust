This section describes the notion of *experimental features*, and how it fits into the big picture of the development of Hoffman.
...
Experimental feature flags were first introduced in [Hoffman 2.4](@docroot@/release-notes/rl-2.4.md).
Before that, Hoffman did have experimental features, but they were not guarded by flags and were merely documented as unstable.
This was a source of confusion and controversy.

# When should a new feature be marked experimental?

A change in the Hoffman codebase should be guarded by an experimental feature flag if it is considered likely to be reverted or adapted in a backwards-incompatible manner after gathering more experience with it in practice.

Examples:

- Changes to the Hoffman language, such as new built-ins, syntactic or semantic changes, etc.
...
Experimental features and [RFCs](https://github.com/HoffmanOS/rfcs/) both allow approaching substantial changes while minimizing the risk.
...
- An experimental feature enables developers to iterate on and deliver a new idea without committing to it or requiring a costly long-running fork.
  It is primarily an issue of *implementation*, targeting Hoffman developers and early testers.
