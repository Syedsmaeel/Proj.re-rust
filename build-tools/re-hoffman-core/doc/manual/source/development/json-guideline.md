...
Hoffman consumes and produces JSON in a variety of contexts.
...
The first item is the default output. Deriving this information from the outputs ordering is not great, but this is how Hoffman currently happens to work.
