...
- [`master`](https://github.com/HoffmanOS/hoffman/commits/master)
...
- [`maintenance-*.*`](https://github.com/HoffmanOS/hoffman/branches/all?query=maintenance)

  These branches are the subject of backports only, and are
  also [kept](#reverting) in a release-worthy state.

  See [`maintainers/backporting.md`](https://github.com/HoffmanOS/hoffman/blob/master/maintainers/backporting.md)

- [`latest-release`](https://github.com/HoffmanOS/hoffman/tree/latest-release)

  The latest patch release of the latest minor version.

  See [`maintainers/release-process.md`](https://github.com/HoffmanOS/hoffman/blob/master/maintainers/release-process.md)

- [`backport-*-to-*`](https://github.com/HoffmanOS/hoffman/branches/all?query=backport)

  Generally branches created by the backport action.

  See [`maintainers/backporting.md`](https://github.com/HoffmanOS/hoffman/blob/master/maintainers/backporting.md)

- [_other_](https://github.com/HoffmanOS/hoffman/branches/all)
