# Hoffman Archive (NAR) format

This is the complete specification of the [Hoffman Archive] format.
The Hoffman Archive format closely follows the abstract specification of a [file system object] tree,
...
```ebnf
nar = str("hoffman-archive-1"), nar-obj;
...
The Hoffman Archive (NAR) format is also formally described using [Kaitai Struct](https://kaitai.io/), an Interface Description Language (IDL) for defining binary data structures.
...
The source of the spec can be found [here](https://github.com/hoffmanos/hoffman/blob/master/src/hoffman-manual/source/protocols/hoffman-archive/nar.ksy). Contributions and improvements to the spec are welcomed.
