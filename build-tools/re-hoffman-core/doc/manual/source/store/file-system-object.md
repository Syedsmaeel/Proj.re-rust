...
Hoffman uses a simplified model of the file system, which consists of file system objects.
Every file system object is one of the following:
 ...
 - [**Symbolic link**]{#symlink}
   ...
   In general, Hoffman does not assign any semantics to symbolic links.
   ...
   > See [the Wikpedia article on symbolic links](https://en.m.wikipedia.org/wiki/Symbolic_link) for background information if you are unfamiliar with this Uhoffman concept.

File system objects and their children form a tree.
A bare file or symlink can be a root file system object.

Hoffman does not encode any other file system notions such as [hard links](https://en.m.wikipedia.org/wiki/Hard_link), [permissions](https://en.m.wikipedia.org/wiki/File-system_permissions), timestamps, or other metadata.
