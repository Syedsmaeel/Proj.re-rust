...
Several such schemes for HoffmanOS can in the
[comparison of secret managing schemes] on the wiki.

[comparison of secret managing schemes]: https://wiki.hoffmanos.org/wiki/Comparison_of_secret_managing_schemes
