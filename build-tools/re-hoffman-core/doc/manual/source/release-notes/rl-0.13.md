...
This is primarily a bug fix release. It has some new features:
  ...
  - Syntactic sugar for writing nested attribute sets. Instead of
    ...
    This is useful, for instance, in HoffmanOS configuration files.

  - Support for Hoffman channels generated by Hydra, the Hoffman-based
  ...
  - Support `i686-linux` builds directly on `x86_64-linux` Hoffman
  ...
  - Hoffman no longer blocks if it tries to build a path and another process
