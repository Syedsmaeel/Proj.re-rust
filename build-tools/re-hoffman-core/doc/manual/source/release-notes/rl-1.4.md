...
possible for derivations to cause the mode of files outside of the Hoffman
store to be changed to 444 (read-only but world-readable) by creating
hard links to those files
([details](https://github.com/HoffmanOS/hoffman/commit/5526a282b5b44e9296e61e07d7d2626a79141ac4)).

There are also the following improvements:

  - New built-in function: `builtins.hashString`.

  - Build logs are now stored in `/hoffman/var/log/hoffman/drvs/XX/`, where *XX*
