...
in certain situations. In addition, it has the following new features:
  ...
  - `hoffman-daemon` now respects `--store`.

  - `hoffman run` now respects `hoffman-support/propagated-user-env-packages`.
