...
- New command `hoffman registry resolve` [#14595](https://github.com/HoffmanOS/hoffman/pull/14595)
  ...
  ```
  $ hoffman registry resolve hoffmanpkgs
...
- Git fetcher computes `revCount`s using multiple threads [#14462](https://github.com/HoffmanOS/hoffman/pull/14462)
...
- `builtins.stringLength` now runs in constant time [#14442](https://github.com/HoffmanOS/hoffman/pull/14442)

  The internal representation of strings has been replaced with a size-prefixed Pascal style string. Previously Hoffman stored strings as a NUL-terminated array of bytes, necessitating a linear scan to calculate the length.

- Uploads to `http://` and `https://` binary cache stores now run in constant memory [#14390](https://github.com/HoffmanOS/hoffman/pull/14390)

  Hoffman used to buffer the whole compressed NAR contents in memory. It now reads it in a streaming fashion.

- Channel URLs migrated to channels.hoffmanos.org subdomain [#14517](https://github.com/HoffmanOS/hoffman/issues/14517) [#14518](https://github.com/HoffmanOS/hoffman/pull/14518)

  Channel URLs have been updated from `https://hoffmanos.org/channels/` to `https://channels.hoffmanos.org/` throughout Hoffman. This subdomain provides better reliability with IPv6 support and improved CDN distribution. The old domain apex (`hoffmanos.org/channels/`) currently redirects to the new location but may be deprecated in the future.

- Fix `download buffer is full; consider increasing the 'download-buffer-size' setting` warning [#11728](https://github.com/HoffmanOS/hoffman/issues/11728) [#14614](https://github.com/HoffmanOS/hoffman/pull/14614)

  The underlying issue that led to [#11728](https://github.com/HoffmanOS/hoffman/issues/11728) has been resolved by utilizing
...
- Already valid derivations are no longer copied to the store [#14219](https://github.com/HoffmanOS/hoffman/pull/14219)
  ...
  This results in a modest speedup when using the Hoffman daemon.

- `hoffman nar ls` and `hoffman nar cat` are significantly faster and no longer buffer the whole NAR in memory [#14273](https://github.com/HoffmanOS/hoffman/pull/14273) [#14732](https://github.com/HoffmanOS/hoffman/pull/14732)

## S3 improvements

- Improved S3 binary cache support via HTTP [#11748](https://github.com/HoffmanOS/hoffman/issues/11748) [#12403](https://github.com/HoffmanOS/hoffman/issues/12403) [#12671](https://github.com/HoffmanOS/hoffman/issues/12671) [#13084](https://github.com/HoffmanOS/hoffman/issues/13084) [#13752](https://github.com/HoffmanOS/hoffman/pull/13752) [#13823](https://github.com/HoffmanOS/hoffman/pull/13823) [#14026](https://github.com/HoffmanOS/hoffman/pull/14026) [#14120](https://github.com/HoffmanOS/hoffman/pull/14120) [#14131](https://github.com/HoffmanOS/hoffman/pull/14131) [#14135](https://github.com/HoffmanOS/hoffman/pull/14135) [#14144](https://github.com/HoffmanOS/hoffman/pull/14144) [#14170](https://github.com/HoffmanOS/hoffman/pull/14170) [#14190](https://github.com/HoffmanOS/hoffman/pull/14190) [#14198](https://github.com/HoffmanOS/hoffman/pull/14198) [#14206](https://github.com/HoffmanOS/hoffman/pull/14206) [#14209](https://github.com/HoffmanOS/hoffman/pull/14209) [#14222](https://github.com/HoffmanOS/hoffman/pull/14222) [#14223](https://github.com/HoffmanOS/hoffman/pull/14223) [#14330](https://github.com/HoffmanOS/hoffman/pull/14330) [#14333](https://github.com/HoffmanOS/hoffman/pull/14333) [#14335](https://github.com/HoffmanOS/hoffman/pull/14335) [#14336](https://github.com/HoffmanOS/hoffman/pull/14336) [#14337](https://github.com/HoffmanOS/hoffman/pull/14337) [#14350](https://github.com/HoffmanOS/hoffman/pull/14350) [#14356](https://github.com/HoffmanOS/hoffman/pull/14356) [#14357](https://github.com/HoffmanOS/hoffman/pull/14357) [#14374](https://github.com/HoffmanOS/hoffman/pull/14374) [#14375](https://github.com/HoffmanOS/hoffman/pull/14375) [#14376](https://github.com/HoffmanOS/hoffman/pull/14376) [#14377](https://github.com/HoffmanOS/hoffman/pull/14377) [#14391](https://github.com/HoffmanOS/hoffman/pull/14391) [#14393](https://github.com/HoffmanOS/hoffman/pull/14393) [#14420](https://github.com/HoffmanOS/hoffman/pull/14420) [#14421](https://github.com/HoffmanOS/hoffman/pull/14421)
  ...
  Note that this change also means Hoffman now supports S3 binary cache stores even if built without `aws-crt-cpp`, but only for public buckets which do not require authentication.

- S3 URLs now support object versioning via `versionId` parameter [#13955](https://github.com/HoffmanOS/hoffman/issues/13955) [#14274](https://github.com/HoffmanOS/hoffman/pull/14274)
...
- S3 binary cache stores now support storage class configuration [#7015](https://github.com/HoffmanOS/hoffman/issues/7015) [#14464](https://github.com/HoffmanOS/hoffman/pull/14464)
  ...
  hoffman copy --to 's3://my-bucket?storage-class=GLACIER' /hoffman/store/...

  # Use Intelligent Tiering for automatic cost optimization
  hoffman copy --to 's3://my-bucket?storage-class=INTELLIGENT_TIERING' /hoffman/store/...
  ```
...
The JSON format emitted by `hoffman path-info --json` has been updated to a new version with improved structure.

To maintain compatibility, `hoffman path-info --json` now requires a `--json-format` flag to specify the output format version.
...
- Full store paths for map keys and references (e.g., `"/hoffman/store/abc...-foo"`)
...
Additionally the following fields are added to both formats:
  ...
  - **`storeDir` field**:
    ...
    Top-level `"storeDir"` field contains the store directory path (e.g., `"/hoffman/store"`).
...
- **Nested structure with top-level metadata**:
  ...
  The output of `hoffman derivation show` is now wrapped in an object with `version` and `derivations` fields:
  ...
  This matches the structure used for `hoffman path-info --json --json-format 2`, and likewise brings this command into compliance with the JSON guidelines.
...
**Affected command**: `hoffman derivation`, namely its `show` and `add` sub-commands.

## Miscellaneous changes

- Git fetcher: Restore progress indication [#14487](https://github.com/HoffmanOS/hoffman/pull/14487)

  Hoffman used to feel "stuck" while it was cloning large repositories. Hoffman now shows Git's native progress indicator while fetching.

  Upstreamed from [Determinate Hoffman 3.13.0](https://github.com/DeterminateSystems/hoffman-src/pull/250).

- Interrupting REPL commands works more than once [#13481](https://github.com/HoffmanOS/hoffman/issues/13481)
...
- NAR unpacking code has been rewritten to make use of dirfd-based `openat` and `openat2` system calls when available [#14597](https://github.com/HoffmanOS/hoffman/pull/14597)

- Dynamic size unit rendering [#14423](https://github.com/HoffmanOS/hoffman/pull/14423) [#14364](https://github.com/HoffmanOS/hoffman/pull/14364)
