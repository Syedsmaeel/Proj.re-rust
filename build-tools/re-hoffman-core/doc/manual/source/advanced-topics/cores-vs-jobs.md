...
Hoffman has two relevant settings with regards to how your CPU cores will
...
they are, how they interact, and their configuration trade-offs.
  ...
  - `max-jobs`\
    ...
    builds.  Hoffman will still substitute from binary caches, and build
...
`HOFFMAN_BUILD_CORES`. `HOFFMAN_BUILD_CORES` is equal to `cores`, unless
`cores` equals `0`, in which case `HOFFMAN_BUILD_CORES` will be the total
number of cores in the system.

The maximum number of consumed cores is a simple multiplication,
`max-jobs` \* `HOFFMAN_BUILD_CORES`.
...
| `max-jobs` | `cores` | `HOFFMAN_BUILD_CORES` | Maximum Processes | Result                                                                                                                                                                                                                                                                                 |
| --------------------- | ------------------ | ----------------- | ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
cores-per-build by following the value of the `HOFFMAN_BUILD_CORES`
