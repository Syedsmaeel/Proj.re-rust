...
1. Run software without installing it permanently:
   ...
   ```console
   $ hoffman-shell --packages cowsay lolcat
   ```
   ...
   ```console
   [hoffman-shell:~]$ cowsay Hello, Hoffman! | lolcat
   ```
...
1. Search for more packages on [search.hoffmanos.org](https://search.hoffmanos.org/) to try them out.
