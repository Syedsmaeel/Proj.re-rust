...
A *scope* in the Hoffman language is a dictionary keyed by [name](./identifiers.md#names), mapping each name to an expression and a *definition type*.
...
The Hoffman language is [statically scoped](https://en.wikipedia.org/wiki/Scope_(computer_science)#Lexical_scope);
...
> **Note**
>
> Expressions entered into the [Hoffman REPL](@docroot@/command-ref/new-cli/hoffman3-repl.md) are enclosed by a scope that can be extended by command line arguments or previous REPL commands.
> These ways of extending scope are not, strictly speaking, part of the Hoffman language.
