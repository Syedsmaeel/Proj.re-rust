...
Evaluation is the process of turning a Hoffman expression into a [Hoffman value](types.md).
...
These rules are applied as needed, driven by the specific use of the expression. For example, this can occur in the Hoffman command line interface or interactively with the [repl (read-eval-print loop)](@docroot@/command-ref/new-cli/hoffman3-repl.md), which is a useful tool when learning about evaluation.

# Details

## Values {#values}

Hoffman values can be thought of as a subset of Hoffman expressions.
