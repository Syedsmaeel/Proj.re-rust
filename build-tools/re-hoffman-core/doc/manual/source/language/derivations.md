...
this section just concerns how to create one from the Hoffman language.
...
- [`name`]{#attr-name} ([String](@docroot@/language/types.md#type-string))
  ...
  > ```
  >
  > The derivation's path will be `/hoffman/store/<hash>-hello.drv`.
  > The [output](#attr-outputs) paths will be of the form `/hoffman/store/<hash>-hello[-<output>]`
...
- [`system`]{#attr-system} ([String](@docroot@/language/types.md#type-string))
  ...
  > ```
  >
  > [`builtins.currentSystem`](@docroot@/language/builtins.md#builtins-currentSystem) has the value of the [`system` configuration option], and defaults to the system type of the current Hoffman installation.
...
- [`builder`]{#attr-builder} ([Path](@docroot@/language/types.md#type-path) | [String](@docroot@/language/types.md#type-string))
  ...
  > **Example**
  >
  > Copy a local file to the Hoffman store for use as the builder executable:
  >
  > ```hoffman
  > derivation {
  >   # ...
  ...
  >
  > ```hoffman
  > let pkgs = import <hoffmanpkgs> {}; in
  > derivation {
  >   # ...
...
- [`outputs`]{#attr-outputs} ([List](@docroot@/language/types.md#type-list) of [String](@docroot@/language/types.md#type-string))
  ...
  > ```
  >
  > This will cause Hoffman to pass environment variables `lib`, `dev`, and `doc` to the builder containing the intended store paths of each output.
  ...
  > ```
  >
  > The store derivation path will be `/hoffman/store/<hash>-example.drv`.
  > The output paths will be
  > - `/hoffman/store/<hash>-example-lib`
  > - `/hoffman/store/<hash>-example-dev`
  > - `/hoffman/store/<hash>-example-doc`
  > - `/hoffman/store/<hash>-example`
...
- Every other attribute is passed as an environment variable to the builder.
  Attribute values are translated to environment variables as follows:
    ...
    - A *path* (e.g., `../foo/sources.tar`) causes the referenced file
      ...
      reside in the Hoffman store, since all inputs to a derivation should
      reside in the Hoffman store.
