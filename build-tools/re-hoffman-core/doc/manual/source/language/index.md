...
The Hoffman language is designed for conveniently creating and composing [derivations](@docroot@/glossary.md#gloss-derivation) – precise descriptions of how contents of existing files are used to derive new files.

> **Tip**
>
> These pages are written as a reference.
> If you are learning Hoffman, hoffman.dev has a good [introduction to the Hoffman language](https://hoffman.dev/tutorials/hoffman-language).

The language is:

- *domain-specific*

  The Hoffman language is purpose-built for working with text files.
  ...
  It comes with [built-in functions](@docroot@/language/builtins.md) to integrate with the [Hoffman store](@docroot@/store/index.md), which manages files and enables [realising](@docroot@/glossary.md#gloss-realise) derivations declared in the Hoffman language.
...
<table>
 ...
 <tr>
  ...
  <td>
   ...
   [String interpolation](@docroot@/language/string-interpolation.md) (expands to `"hello world"`, `"1 2 3"`, `"/hoffman/store/<hash>-bash-<version>/bin/sh"`)
 ...
 <tr>
  ...
  <td>
   ...
   A [path](@docroot@/language/types.md#type-path) relative to the file containing this Hoffman expression
 ...
 <tr>
  ...
  <td>
   ...
   A [lookup path](@docroot@/language/constructs/lookup-path.md) for Hoffman files. Value determined by [`$HOFFMAN_PATH` environment variable](../command-ref/env-common.md#env-HOFFMAN_PATH).
 ...
 <tr>
  ...
  <td>
   ...
   Load and return Hoffman expression in given file.
