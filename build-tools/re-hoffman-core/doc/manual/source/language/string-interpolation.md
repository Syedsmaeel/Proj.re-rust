...
A more complicated example (from the Hoffman expression for [Qt](http://www.trolltech.com/products/qt)):
...
Note that Hoffman expressions and strings can be arbitrarily nested;
...
> This can be expressed directly in the Hoffman language strings:
>
> ```hoffman
> ''
>   MAKEVAR = Hello
...
A path in an interpolated expression is first copied into the Hoffman store, and the resulting string is the [store path] of the newly created [store object](@docroot@/store/store-object.md).
...
> ```
>
>     "/hoffman/store/2hhl2nz5v0khbn06ys82nrk99aa1xxdw-foo"
...
> ```
>
>     "/hoffman/store/qnlr7906z0mrl2syrkdbpicffq02nw07-hello-2.12.1"
