...
Hoffman has two basic security models. First, it can be used in “single-user
...
Alternatively, you can configure Hoffman in “multi-user mode”. In this
model, all users can perform package management operations — for
instance, every user can install software without requiring root
privileges. Hoffman ensures that this is secure. For instance, it’s not
